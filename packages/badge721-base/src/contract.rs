...
use cosmwasm_std::{
    ...
    MessageInfo, StdResult, Storage, Timestamp, WasmQuery,
};
...
use crate::{ContractError, Badge721Contract};
    ...
    T: Serialize + DeserializeOwned + Clone,
{
    ...
    pub fn execute(
        ...
        match msg {
            ...
            badge721::ExecuteMsg::UpdateOwnership(msg) => self
                .parent
                .execute(
                    deps,
                    env,
